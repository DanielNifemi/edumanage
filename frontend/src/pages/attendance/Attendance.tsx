...
const Attendance = () => {
  ...
  }, [currentView, calculateStats]);
  useEffect(() => {
    fetchData();
  }, [currentView, selectedDate, fetchData]);

  useEffect(() => {
    // Calculate stats when course attendance data is available
    calculateStats([]);
  }, [courseAttendance, calculateStats]);
                      ...
                      <TableRow key={student.id}>
                        <TableCell>
                          ...
                          <input
                            ...
                            aria-label={`Mark ${student.first_name} ${student.last_name} as present`}
                          />
                        </TableCell>
                        <TableCell>
                          <input
                            ...
                            aria-label={`Mark ${student.first_name} ${student.last_name} as absent`}
                          />
                        </TableCell>
                      </TableRow>
                    ))}
